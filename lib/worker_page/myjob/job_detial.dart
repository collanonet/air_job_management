...
class JobScreenDetial extends StatefulWidget {
  JobScreenDetial({key, required this.info, this.docId, this.index}) : super(key: key);
  SearchJob info;
  var docId;
  int? index;
...
class _JobScreenDetialState extends State<JobScreenDetial> {
  ...
  static const snackBar = SnackBar(
    content: Text("Problem Ahead Please Change Route, if you cannot change route then please proceed with carefull"),
  );
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(image: NetworkImage(widget.info.image.toString()), fit: BoxFit.cover),
                        ),
                      ),
                      Positioned(
                        top: 10,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(widget.info.salaryRange ?? "", style: kNormalText),
                            ),
                          ],
                        ),
                        Row(
