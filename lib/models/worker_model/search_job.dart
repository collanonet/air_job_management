...
class SearchJob {
  ...
  factory SearchJob.fromJson(Map<String, dynamic> json) => SearchJob(
        transportationFeeOptions:
            json["transportationFeeOptions"] ?? JapaneseText.providedTF,
        limitGroupEmail: json["limit_group_email"] != null
            ? List<String>.from(json["limit_group_email"].map((e) => e))
            : [],
        ...
        coverList: json["cover_list"] != null
            ? List<String>.from(json["cover_list"].map((e) => e))
            : [],
