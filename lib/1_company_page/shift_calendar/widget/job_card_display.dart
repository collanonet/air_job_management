...
class JobCardDisplay extends StatelessWidget {
  final String title;
  final JobPosting shiftFrame;
  final JobPosting? selectShiftFrame;
  final Function onClick;
  const JobCardDisplay({super.key, required this.shiftFrame, required this.onClick, this.selectShiftFrame, required this.title});
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Center(
                child: Text(
                  "${shiftFrame.startDate} - ${shiftFrame.endDate}\n${shiftFrame.startTimeHour} - ${shiftFrame.endTimeHour} ",
