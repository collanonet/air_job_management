// import 'package:air_job_management/models/office.dart';
...
//         selectedColor:
//             widget.colorator?.call(item.value) ?? widget.selectedColor ?? Theme.of(context).primaryColor.withOpacity(0.35),
//         label: Text(
//           item.label,
//           style: item.selected
//               ? TextStyle(
