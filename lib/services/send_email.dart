  ...
  static sendEmail(
    ...
    try {
      FirebaseFirestore.instance.collection("mail").add({
        ...
        "message": {
          "subject": msg,
          "text": 'Your request ($request, $date) has been $status by $companyName',
          "html": 'Your request ($request, $date) has been $status by $companyName',
        },
      });
  ...
  static sendEmailApplyShift(
    ...
    try {
      FirebaseFirestore.instance.collection("mail").add({
        ...
        "message": {
          "subject": msg,
          "text": 'Your Shift ($date) has been $status by $companyName',
          "html": 'Your Shift ($date) has been $status by $companyName',
        },
      });
      print('Email request for device sent!');
    } catch (e) {
